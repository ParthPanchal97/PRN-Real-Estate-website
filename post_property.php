...
if(isset($_POST['post'])){
    ...
    if(isset($_POST['security_gaurd'])){
        $security_gaurd = $_POST['security_gaurd'];
        $security_gaurd = filter_var($security_gaurd, FILTER_SANITIZE_STRING);
    }else{
        $security_gaurd = 'no';
    }
    ...
    $rename_image_02 = generate_unique_id().'.'.$image_02_ext;
    ...
    $rename_image_03 = generate_unique_id().'.'.$image_03_ext;
    ...
    $rename_image_04 = generate_unique_id().'.'.$image_04_ext;
    ...
    $rename_image_05 = generate_unique_id().'.'.$image_05_ext;
    ...
    $rename_image_01 = generate_unique_id().'.'.$image_01_ext;
    ...
    if($image_01_size > 2000000){
        ...
        $insert_property = $conn->prepare("INSERT INTO `property`(id, user_id, property_name, address, price, type, offer, status, furnished, bhk, deposite, bedroom, bathroom, balcony, carpet, age, total_floors, room_floor, loan, lift, security_gaurd, play_ground, garden, water_supply, power_backup, parking_area, gym, shopping_mall, hospital, school, market_area, image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
        $insert_property->execute([$id, $user_id, $property_name, $address, $price, $type, $offer, $status, $furnished, $bhk, $deposite, $bedroom, $bathroom, $balcony, $carpet, $age, $total_floors, $room_floor, $loan, $lift, $security_gaurd, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
